...
export const callUpdateInfoUser = (id: string, user: IUser) => {
...
export const callUpdatePassword = (
  ...
  return axios.patch<IBackendRes<IUser>>(`/api/v1/users/password/${id}`, {
    ...user,
  });
};
...
export const callFetchInfoUser = (id: string) => {
