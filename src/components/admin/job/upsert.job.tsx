...
const ViewUpsertJob = (props: any) => {
        ...
        const init = async () => {
            if (id) {
                ...
                if (res && res.data) {
                    ...
                    setSDate(res.data.startDate);
                    setEDate(res.data.endDate);
    ...
    const onFinish = async (values: any) => {
        if (dayjs(values.endDate).format('DD/MM/YYYY') < (dayjs(values.startDate).format('DD/MM/YYYY'))) { 
            notification.error({
                message: 'Có lỗi xảy ra',
                description: "Ngày bắt đầu và kết thúc không hợp lệ!"
            });
            return;
        }
